...
# (여기에 이전 코드에 있던 build_summary_report, get_biz_type_detailed_report, get_biz_report, to_excel_multiple 함수들을 모두 여기에 붙여넣으세요)
...
if uploaded_file:
    ...
    # 2. 매출 요약 (Item) -> ACT 기준 내림차순 정렬 적용
