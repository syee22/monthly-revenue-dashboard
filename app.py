...
def format_percentage_html(val):
    ...
    if 0.95 <= val <= 1.0:
        bar_html = '<span style="display:inline-block; width:10px; height:2.5px; background-color:#404040;vertical-align:middle;text-shadow: 1px 1px 1px rgba(0,0,0,0.3);"></span>'
