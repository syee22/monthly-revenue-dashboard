...
def format_percentage_html(val):
    ...
    if 0.95 <= val <= 1.0:
        bar_html = '<span style="display:inline-block; width:15px; height:2px; background-color:#404040; vertical-align:middle; margin-left:4px;"></span>'
        return f'<span style="color: #404040; font-style: italic;">{pct_str} {bar_html}<span style={shadow}">━</span></span>' 
    elif val > 1.0:
